![Image text](https://github.com/hexu6788/XamarinForms-Samples/blob/master/doc/image/XamarinForms-Samples.png)
...
* SQLite数据库
   ...
   * [DELETE(删除)](https://github.com/hexu6788/XamarinForms-Samples/blob/master/Code/Samples/Samples/Directory/SQLite/DELETE/SQLiteDelete.xaml.cs "DELETE(删除)")
   ...
   * [UPDATE(修改)](https://github.com/hexu6788/XamarinForms-Samples/blob/master/Code/Samples/Samples/Directory/SQLite/UPDATE/SQLiteUpdate.xaml.cs "UPDATE(修改)")
